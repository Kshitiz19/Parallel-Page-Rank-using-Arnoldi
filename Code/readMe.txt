...
2) You can decide the loop stopping criteria in pagerank.cu based on either no. of iterations or based on difference between consecutive iteration values of Aq-q
